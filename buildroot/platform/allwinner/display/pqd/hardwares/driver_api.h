...
enum {
    ...
    DISP_LCD_SET_BLACK_EXTENSION = 0x504,
    DISP_LCD_GET_BLACK_EXTENSION = 0x505,
    DISP_CDC_SET_DAT = 0x508,
    DISP_CDC_GET_DAT = 0x509,
};
...
struct cdc_dat {
    unsigned int cmd;
    unsigned int CDC_LUT0[729];
    unsigned int CDC_LUT1[648];
    unsigned int CDC_LUT2[648];
    unsigned int CDC_LUT3[576];
    unsigned int CDC_LUT4[648];
    unsigned int CDC_LUT5[576];
    unsigned int CDC_LUT6[576];
    unsigned int CDC_LUT7[512];
};

struct black_extension {
    int id;
    char percent_black;
    char percent_white;
