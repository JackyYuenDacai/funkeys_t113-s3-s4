...
struct pqal {
    ...
    /* lti sharp */
    int (*set_lti)(const char* data, int size);
    int (*get_lti)(char* data, int size);

    /* peak sharp */
    int (*set_peak)(const char* data, int size);
    int (*get_peak)(char* data, int size);
    ...
    /* cdc */
    int (*set_cdc)(const char* data, int size);
    int (*get_cdc)(char* data, int size);
    /* fce black extend */
    int (*set_fce_be)(const char* data, int size);
    int (*get_fce_be)(char* data, int size);
};
